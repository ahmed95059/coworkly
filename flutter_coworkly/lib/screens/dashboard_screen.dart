...
class DashboardScreen extends StatelessWidget {
              ...
              child: Column(
                children: [
                  if (appProvider.isAdmin) ...[
                    _buildAdminAccess(context, appProvider),
  ...
  Widget _buildHeader(BuildContext context, User? user) {
    ...
    final avatar = user?.avatar ?? 'NA';
    final hours = user?.hours ?? 0;
    final spending = user?.spending ?? 0;
    final streak = user?.bookings ?? 0;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _buildQuickStat('$hours', 'Heures totales'),
              const SizedBox(width: 12),
              _buildQuickStat('${spending.toStringAsFixed(0)}€', 'Dépensé'),
              const SizedBox(width: 12),
              _buildQuickStat('$streak', 'Jours consécutifs'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildAdminAccess(BuildContext context, AppProvider appProvider) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: const Text('Acceder a la gestion des espaces et reservations'),
