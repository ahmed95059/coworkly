...
class _RoomVisualizationScreenState extends State<RoomVisualizationScreen> {
  ...
  Future<void> _loadSeats() async {
    ...
    final roomId = Provider.of<AppProvider>(context, listen: false).selectedRoomId;
    ...
    try {
      ...
      final mapped = _seatLayout.map((layout) {
        ...
        final status = apiSeat != null ? _mapStatus(apiSeat['status'] as String?) : 'available';
        return {
          'id': apiSeat?['id'],
          'number': number,
          'status': status,
